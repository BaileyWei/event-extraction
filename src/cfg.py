...
extractor.add_argument('--pretrained_bert', type=str, default='bert-base-chinese')
extractor.add_argument('--bert_vocab', type=str, default='/mnt/yubai/ptmodel/bert-base-chinese/vocab.txt')
extractor.add_argument('--extractor_origin_trigger_dir', type=str, default='./save/origin/trigger')
extractor.add_argument('--extractor_origin_role_dir', type=str, default='./save/origin/role1')
extractor.add_argument('--extractor_train_file', type=str, default='../data/train.json')
extractor.add_argument('--extractor_val_file', type=str, default='../data/valid.json')
...
extractor.add_argument('--role_num', type=int, default=16)
...
extractor.add_argument('--extractor_batch_size', type=int, default=16)
...
extractor.add_argument('--do_train_trigger', action="store_true", default='True')
extractor.add_argument('--do_train_argument', action="store_true", default='True')
